...
{
    /// <summary>
    /// Descripción breve de rePrintLabelMI
    /// </summary>
    public class rePrintLabelMI : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (zone != "NOT_FOUND")
                {
                    ...
                    String qr = mag.Replace("-","|") + "|" + model +  "|" + semifinish + "|" + qty;
                    String template = m_db_st.getLabelMI(model, djGroup, semifinish, cgsRoute, qty, qr, mag).First().label;
